...
![npm](https://img.shields.io/npm/v/ai-csp)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-csp)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Content Security Policy (CSP) generation and validation tool

Content Security Policy generator. Creates secure CSP headers to prevent XSS and data injection.

[![npm version](https://img.shields.io/npm/v/ai-csp.svg)](https://www.npmjs.com/package/ai-csp)
[![npm downloads](https://img.shields.io/npm/dm/ai-csp.svg)](https://www.npmjs.com/package/ai-csp)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-csp)](https://github.com/lxgicstudios/ai-csp/stargazers)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue)](https://www.typescriptlang.org/)


AI-powered CSP generator. Creates secure Content Security Policy headers tailored to your app.
...
```bash
npx ai-csp
# Analyzes project and generates CSP headers

npx ai-csp ./my-app -o security.md
```
